    ...
    <div class="demo-collapse">
        <el-collapse>
            <el-collapse-item class="l1">
                <template #title>
                    计算机科学与技术
                    <el-button class="mkson" @click="mkson1"
                    >创建子分支
                    </el-button
                    >
                </template>
                <div v-for="item1 in secmenu" :key="item1.id">
                    <el-collapse-item class="l2">
                        <template #title>
                            ...
                            >
                            <el-button class="mkbro" @click.stop.prevent="addcourse2(item1.id)"
                            >添加课程
                            </el-button
                            >
                        </template>
                        <div v-for="item2 in thirdmenu" :key="item2.id">
                            <el-collapse-item class="l3" v-if="item2.parent == item1.id">
                                <template #title>
                                    ...
                                    >
                                    <el-button class="mkbro" @click.stop.prevent="addcourse3(item2.id)"
                                    >添加课程
                                    </el-button
                                    >
                                </template>
                                    ...
                                    <el-collapse-item class="l4" v-if="item3.parent == item2.id">
                                        <template #title>
                                            ...
                                            <!-- <el-button class="mkson" @click="mkson4(item3.id)"
                                              >创建子分支</el-button
                                            > -->
                                            <el-button class="mkbro" @click.stop.prevent="addcourse4(item3.id)"
                                            >添加课程
                                            </el-button
                                            >
                                        </template>
